...
public class QkartSanity {
    ...
    public static void takeScreenshot(WebDriver driver, String screenshotType, String description) {
        try {
            File theDir = new File("src//resources");
            if (!theDir.exists()) {
                theDir.mkdirs();
            }
    ...
    public static Boolean TestCase02(WebDriver driver) throws InterruptedException {
        Boolean status;
        logStatus("Start Testcase 2", "Test Case 2: Verify User Registration with an existing username ", "DONE");
        ...
        if (!status) {
            logStatus("End TestCase 2", "Test Case 2: Verify user Registration : ", status ? "PASS" : "FAIL");
            return false;
    ...
    public static Boolean TestCase10(WebDriver driver) throws InterruptedException {
        ...
        System.out.println(ContactNow.getText());
        ContactNow.click();
        ...
        status = wait.until(ExpectedConditions
                ...
                logStatus("End TestCase", "Test Case 10: Contact Us functionality verified",
                status ? "PASS" : "FAILED");
