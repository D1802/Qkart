...
public class Home {
    ...
    public Boolean searchForProduct(String product) {
        try {
            ...
            wait.until(ExpectedConditions.or(
                ...
                ExpectedConditions.visibilityOfElementLocated((By.xpath("//div[@class='MuiCardContent-root css-1qw96cp']"))))
            );
    ...
    public Boolean isNoResultFound() {
        ...
        try {
            ...
            WebElement nonproduct =driver.findElement(By.xpath("//h4[text()=' No products found ']"));
         if(nonproduct.isDisplayed())   
            {if(nonproduct.getText().equals(" No products found "))
                status = true;
        }
